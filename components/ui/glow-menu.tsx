              ...
              <motion.li key={item.label} className="relative">
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      className={cn(
                        "flex items-center gap-1 px-3 py-1.5 relative z-10 bg-transparent transition-colors rounded-xl text-[15px] font-medium",
                        isActive
                          ? "text-foreground"
                    ...
                    >
                      ...
                      >
                        <Icon className="h-4 w-4 min-w-[1rem] min-h-[1rem]" />
                      </span>
                      <span>{item.label}</span>
                    </motion.div>
                    <motion.div
                      className={cn(
                        "flex items-center gap-1 px-3 py-1.5 absolute inset-0 z-10 bg-transparent transition-colors rounded-xl text-[15px] font-medium",
                        isActive
                          ? "text-foreground"
                          : "text-muted-foreground group-hover:text-foreground",
                      )}
